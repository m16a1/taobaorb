...
describe Taobao::Product do
  ...
  describe 'initialize with id' do
    it 'should returns product' do
      ...
      subject.pic_url.should == 'http://img01.taobaocdn.com/bao/uploaded/i1/T1XPLZXhJmXXXmXQ.0_035913.jpg'
      subject.price.should == 4530.00
      subject.title.should == 'Apple/苹果 iPhone 4S 未激活送礼包 完美越狱'

      subject.approve_status.should == 'onsale'
      subject.auction_point.should == 0
      subject.delist_time.should == DateTime.new(2013,03,11, 12,25,28)
